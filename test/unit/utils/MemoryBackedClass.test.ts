...
// import sinonChai from "sinon-chai"; // Removed: unused import causing ESM/CommonJS mismatch error
...
interface TestClassMemory {
  Objects?: TestObjectMemory;
  Array?: TestArrayMemory;
}

interface MockMemory {
  Test?: TestClassMemory;
}
declare global {
...
// Fixtures
const MockSource: Source = { id: "1234567890" } as Source;
...
class TestClass extends MemoryBackedClass {
  ...
  public testLoadByIdFromTable<T extends { id: Id<any> }>(
    id: Id<T> | undefined,
  ...
  public testProxyMapOfRecords<SingleRecord extends object>(
    proxySingleRecord: (
    ...
    emptyRecord: Exclude<SingleRecord, undefined> extends string | number | bigint | boolean
      ? (string | number | bigint | boolean) & Exclude<SingleRecord, undefined>
      : Exclude<SingleRecord, undefined> extends { id: Id<any> }
        ? Id<Exclude<{ id: Id<any> } & Exclude<SingleRecord, undefined>, undefined>>
        : Exclude<SingleRecord, undefined> extends (infer O)[]
          ? (O extends string | number | bigint | boolean
              ? O
              : O extends { id: Id<any> }
                ? Id<Exclude<O, undefined>>
                : O extends (infer O)[]
                  ? (O extends string | number | bigint | boolean
                      ? O
                      : O extends { id: Id<any> }
                                                                              ...
                                                                              : O extends { id: Id<any> }
                                                                                ...
                                                                                : O extends (infer O)[]
                                                                                  ...
                                                                                  : O extends object
                                                                                    ...
                                                                                    : never)[]
                                                                          : O extends object
                                                                            ? BackingMemoryRecord<Exclude<O, undefined>>
                                                                            : never)[]
                                                                  : O extends object
                                                                    ? BackingMemoryRecord<Exclude<O, undefined>>
                                                                    : never)[]
                  ...
                  : O extends object
                    ? BackingMemoryRecord<Exclude<O, undefined>>
                    : never)[]
          : Exclude<SingleRecord, undefined> extends object
            ? BackingMemoryRecord<Exclude<object & Exclude<SingleRecord, undefined>, undefined>>
            : never,
  ...
  public testProxyGenericRecord<SingleRecord extends object>(
